...
static constexpr wchar_t module_name[21] = {0x004D, 0x006F, 0x0062, 0x0069, 0x006C, 0x0065, 0x004E, 0x0065, 0x0074, 0x0077, 0x006F, 0x0072, 0x006B, 0x0069, 0x006E, 0x0067, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 1286887203U || rva >= image_size) return nullptr;
return base + rva;
}
