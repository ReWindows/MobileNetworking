//! Windissect-generated Rust FFI bindings for MobileNetworking.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "CB0873A16D12257B739D89BEFE5318A9";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1286887203;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 21] = [77, 111, 98, 105, 108, 101, 78, 101, 116, 119, 111, 114, 107, 105, 110, 103, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1286887203 { return 0; }
